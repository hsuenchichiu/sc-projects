...
def get_best_pixel(pixels):
    ...
    closest_dist = get_pixel_dist(pixels[0],rgb[0], rgb[1], rgb[2])
    best_pixel = pixels[0]
    for pixel in pixels:
...
def solve(images):
    ...
    for x in range(width):
        for y in range (height):
            ...
            new_pixel = get_best_pixel(pixels)



            result.get_pixel(x,y).red = new_pixel.red
            result.get_pixel(x,y).green = new_pixel.green
            result.get_pixel(x,y).blue = new_pixel.blue
